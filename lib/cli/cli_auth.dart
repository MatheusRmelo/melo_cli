...
class CliAuth {
  ...
  Future<void> _createData(String path) async {
    await CliHelper.copyFileFromExample(
        ...
        '$examplePath\\modules\\$name\\data\\data_sources\\${datasourceType.getName(name)}_remote_datasource.dart',
  ...
  Future<void> _createDomain(String path) async {
    await CliHelper.copyFileFromExample(
        ...
        singularName: '');
    await CliHelper.copyFileFromExample(
        '$path\\domain\\models\\user_model.dart',
        '$examplePath\\modules\\$name\\domain\\models\\user_model.dart',
        pluralName: '',
        singularName: '');
    await CliHelper.copyFileFromExample(
